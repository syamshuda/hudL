...
<head>
  ...
  <title>Kurikulum - <?php echo $nama_situs; ?></title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top shadow-sm">
  <div class="container">
    <a class="navbar-brand" href="kurikulum_dashboard.php">
      <img src="assets/img/logo.png" alt="Logo" style="height:30px;margin-right:10px;">
      <?php echo $nama_situs; ?> (Kurikulum)
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item"><a class="nav-link" href="kurikulum_dashboard.php">Dashboard</a></li>
        <li class="nav-item"><a class="nav-link" href="#">Pemetaan Kurikulum</a></li>
        <li class="nav-item"><a class="nav-link" href="#">QA Soal</a></li>
        <li class="nav-item"><a class="nav-link" href="#">KKM</a></li>
