<?php
// templates/header.php (Untuk Guru)
...
<head>
    ...
    <title>Guru - <?php echo $nama_situs; ?></title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="rekap_nilai.php">Rekap Nilai</a>
                    </li>
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="kolaborasi_index.php">Kolaborasi</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                             <li><a class="dropdown-item" href="guru_profil.php">Profil Saya</a></li>
